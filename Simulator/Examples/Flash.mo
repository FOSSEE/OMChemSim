...
package Flash
  ...
  //=====================================================================
    ...
    ms S1( C = C, DelF = 5, Disturbance_Variable = types.variable.Flow, Inlet_Disturbance = types.disturbance.Step,Nc = Nc, UserInput = true, timestep = 10) annotation(
    ...
    Simulator.Examples.Flash.fls B1( C = C, Dynamics = true,Nc = Nc) annotation(
