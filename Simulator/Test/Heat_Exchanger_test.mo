...
package Heat_Exchanger_test
  ...
  model HX_Test
    ...
    Simulator.Test.Heat_Exchanger_test.MS In_Hot(Nc = Nc, C = C) annotation(
      Placement(visible = true, transformation(origin = {-86, 38}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Simulator.Test.Heat_Exchanger_test.MS Out_Hot(Nc = Nc, C = C) annotation(
      Placement(visible = true, transformation(origin = {68, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Simulator.Test.Heat_Exchanger_test.MS In_Cold(Nc = Nc, C = C) annotation(
      Placement(visible = true, transformation(origin = {-22, 64}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Simulator.Test.Heat_Exchanger_test.MS Out_Cold(Nc = Nc, C = C) annotation(
