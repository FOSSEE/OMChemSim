...
package cooler1
  model ms
    ...
    extends Simulator.Streams.Material_Stream(Nc = 2);
  ...
  model cool
    ...
    Simulator.Unit_Operations.Cooler cooler1(Pdel = 0, Eff = 1, Nc = 3, C = {meth, eth, wat}) annotation(
    ...
    Simulator.Test.cooler1.ms outlet(Nc = 3, C = {meth, eth, wat}, T(start = 352.6146), x_pc(start = {{0.33, 0.33, 0.34}, {0.27, 0.32, 0.39}, {0.48, 0.33, 0.18}}), P(start = 101325)) annotation(
