  ...
  package Files
    package Chemsep_Database
      ...
      model Acetylchloride
        extends General_Properties(SN = 40, name = "Acetylchloride", CAS = "75-36-5", Tc = 508, Pc = 5740000, Vc = 0.196, Cc = 0.266, Tb = 323.9, Tm = 160.3, TT = 160.3, TP = 0.0945737, MW = 78.4976, LVB = 0.0713449, AF = 0.334018, SP = 19730, DM = 9.07E-30, SH = 28450000.0, IGHF = -2.4351E+08, GEF = -2.058E+08, AS = 295000, HFMP = 2.75307E+08, HOC = -8.7599E+08, LiqDen = {105, 1.4254, 0.27938, 508, 0.26304, 0}, VP = {101, 99.17638, -7177.914, -11.22425, -0.0000057394, 2}, LiqCp = {16, 42690, 1356.4, -2.0032, 0.038796, -0.000032805}, HOV = {106, 4.0E+07, 0.3, 0, 0, 0}, VapCp = {16, 55490, -733.46, 11.97, -0.00022853, 6.1958E-08}, LiqVis = {101, 4.4371, 130.26, -2.2299, -8.5166E-07, 2}, VapVis = {102, 5.0377E-08, 0.94052, 79.768, -9041.6, 0}, LiqK = {16, 0.11965, 1957.5, -32.911, 0.1548, -0.00027429}, VapK = {102, -27944, 0.34599, -4.878E+09, -7.8546E+10, 0}, Racketparam = 0.26125, UniquacR = 2.438365, UniquacQ = 2.208, ChaoSeadAF = 0.334018, ChaoSeadSP = 20189.2, ChaoSeadLV = 0.0712327);
      end Acetylchloride;
      ...
      model TwomethylTwobutene
        extends General_Properties(SN = 107, name = "TwomethylTwobutene", CAS = "513-35-9", Tc = 470, Pc = 3860000, Vc = 0.292, Cc = 0.288, Tb = 311.7, Tm = 139.39, TT = 139.39, TP = 0.01937, MW = 70.134, LVB = 0.10757, AF = 0.339, SP = 15210, DM = 1.13E-30, SH = -27600000.0, IGHF = -4.18E+07, GEF = 6.045E+07, AS = 338600, HFMP = 7597700, HOC = -3.1088E+09, LiqDen = {105, 0.93623, 0.2731, 470, 0.25849, 0}, VP = {101, 82.2327, -5590.502, -9.366663, 0.0000104545, 2}, LiqCp = {16, 127040, 1071.7, -7.883, 0.075072, -0.000089164}, HOV = {106, 4.3456E+07, 0.64226, -0.070051, -0.5395, 0.35656}, VapCp = {16, 75343, -774.17, 12.975, -0.00022009, 6.0763E-08}, LiqVis = {101, -11.234, 703.42, 0.094871, -0.0000017625, 2}, VapVis = {102, 8.6256E-07, 0.47637, 263.56, -2475.7, 0}, LiqK = {16, -0.050847, 3.0532, -1.4724, -0.00063704, -0.0000020121}, VapK = {102, 0.00020806, 0.92265, 107.34, 175680, 0}, Racketparam = 0.260813, UniquacR = 3.5919, UniquacQ = 3.22, ChaoSeadAF = 0.27667, ChaoSeadSP = 15247.2, ChaoSeadLV = 0.106707);
      end TwomethylTwobutene;

      model Onepentene
        extends General_Properties(SN = 108, name = "Onepentene", CAS = "109-67-1", Tc = 464.8, Pc = 3560000, Vc = 0.2984, Cc = 0.275, Tb = 303.11, Tm = 108.016, TT = 108.016, TP = 0.000037, MW = 70.134, LVB = 0.1104, AF = 0.237, SP = 14410, DM = 1.7E-30, SH = -27600000.0, IGHF = -2.162E+07, GEF = 7.837E+07, AS = 346200, HFMP = 5937400, HOC = -3.13037E+09, LiqDen = {105, 0.44335, 0.18566, 473.43, 0.23587, 0}, VP = {101, 39.52954, -3893.399, -2.686504, 1.952359E-06, 2}, LiqCp = {16, 92753, 117.21, 8.6537, 0.007447, -0.0000026759}, HOV = {106, 3.077277E+07, -0.570706, 2.243398, -2.258065, 0.928488}, VapCp = {16, 66520, -609.44, 12.683, 0.000062395, -2.5354E-08}, LiqVis = {101, -10.79591, 682.8004, 0.00564316, -9.176806E-07, 2}, VapVis = {102, 0.0000017549, 0.42295, 561.21, -17046, 0}, LiqK = {16, -0.010825, -30.065, -1.1172, -0.0023327, -0.0000015541}, VapK = {102, 0.0000026412, 1.549, -2.5891, 24389, 0}, Racketparam = 0.2944, UniquacR = 3.5953, UniquacQ = 3.104, ChaoSeadAF = 0.2198, ChaoSeadSP = 14420.78, ChaoSeadLV = 0.1104);
      end Onepentene;
      ...
      model Tetraethyleneglycol
        extends General_Properties(SN = 160, name = "Tetraethyleneglycol", CAS = "112-60-7", Tc = 795, Pc = 2590000, Vc = 0.564, Cc = 0.221, Tb = 602.7, Tm = 268.15, TT = 268.15, TP = 0.0000138348, MW = 194.226, LVB = 0.172862, AF = 0.917442, SP = 23690, DM = 1.08E-29, SH = -168070000.0, IGHF = -8.83E+08, GEF = -5.599E+08, AS = 650100, HFMP = 3.66E+07, HOC = -4.3431E+09, LiqDen = {105, 0.46229, 0.26105, 795, 0.27055, 0}, VP = {101, 106.7938, -15323.17, -10.86107, -5.284752E-07, 2}, LiqCp = {16, 180650, -180.95, 12.547, 0.0020505, -0.0000018444}, HOV = {106, 1.282157E+08, 0.159236, 1.504015, -1.941373, 0.658104}, VapCp = {16, 122630, -416.14, 13.02, 0.00050957, -2.1012E-07}, LiqVis = {101, -702.8128, 30403.47, 106.7279, -0.000116388, 2}, VapVis = {102, 7.6872E-08, 0.801, 119.91, 0.29361, 0}, LiqK = {16, -0.11138, -134.47, -0.46393, -0.00084854, -4.1141E-07}, VapK = {102, 0.00016749, 0.91863, 699.93, 16777, 0}, Racketparam = 0, UniquacR = 8.1269, UniquacQ = 7.440001, ChaoSeadAF = 0.930639, ChaoSeadSP = 23571.8, ChaoSeadLV = 0.173363);
      ...
      model OneTwoThreeFourtetramethylbenzene
        extends General_Properties(SN = 297, name = "OneTwoThreeFourtetramethylbenzene", CAS = "488-23-3", Tc = 690, Pc = 2860000, Vc = 0.482, Cc = 0.256, Tb = 478.19, Tm = 266.9, TT = 266.9, TP = 2.9878, MW = 134.218, LVB = 0.149073, AF = 0.417172, SP = 18860, DM = 1.66E-30, SH = -1209000000.0, IGHF = -3.305E+07, GEF = 1.324E+08, AS = 416500, HFMP = 1.123E+07, HOC = -5.5376E+09, LiqDen = {105, 0.62671, 0.276, 690, 0.30501, 0}, VP = {101, 103.3938, -9866.6, -11.74655, 5.432648E-06, 2}, LiqCp = {16, 191090, -1527.7, 20.231, -0.019977, 0.000019333}, HOV = {106, 6.827737E+07, 0.20659, 0.354625, 0.156354, -0.400825}, VapCp = {16, 108680, -536.06, 13.006, 0.00026578, -1.0197E-07}, LiqVis = {101, -12.555, 1810.8, 0.0032112, -3.0199E-09, 2}, VapVis = {102, 8.0975E-08, 0.80432, 144.14, -8326.5, 0}, LiqK = {16, -0.046705, -31.572, -1.2356, -0.0012463, -2.6103E-07}, VapK = {102, 0.0001001, 1.0331, 653.92, 21466, 0}, Racketparam = 0.256, UniquacR = 6.1278, UniquacQ = 4.672, ChaoSeadAF = 0.417172, ChaoSeadSP = 18860, ChaoSeadLV = 0.149073);
      ...
      model Heptanal
        extends General_Properties(SN = 322, name = "Heptanal", CAS = "111-71-7", Tc = 603, Pc = 2800000, Vc = 0.421, Cc = 0.267, Tb = 425.95, Tm = 230.15, TT = 229.8, TP = 1.44979, MW = 114.185, LVB = 0.140287, AF = 0.488466, SP = 17780, DM = 8.6E-30, SH = -1209000000.0, IGHF = -2.6401E+08, GEF = -8.653E+07, AS = 461380, HFMP = 2.359E+07, HOC = -4.136E+09, LiqDen = {105, 0.53646, 0.24452, 616.81, 0.26981, 0}, VP = {101, 108.36, -9179.6, -12.655, 0.0000073363, 2}, LiqCp = {16, 200220, 128.23, 7.474, 0.012008, -0.0000080423}, HOV = {106, 6.244116E+07, 0.224744, 0.949788, -1.500319, 0.675167}, VapCp = {16, 131660, -858.87, 13.596, -0.00041213, 8.8955E-08}, LiqVis = {101, 8.4077, 475.87, -3.0758, 0.0000053404, 2}, VapVis = {102, 1.4563E-07, 0.72362, 184.89, -7288.6, 0}, LiqK = {16, 0.02754, -55.074, -1.243, -0.0022084, -0.0000010637}, VapK = {102, 1569.2, 1.0102, 1.4874E+10, 2.7536E+11, 0}, Racketparam = 0.267, UniquacR = 5.2711, UniquacQ = 4.496, ChaoSeadAF = 0.42794, ChaoSeadSP = 17780, ChaoSeadLV = 0.140287);
      end Heptanal;
    ...
    package Thermodynamic_Packages
      model Raoults_Law
        ...
        Real K[Noc](each min = 0), Cpres[3], Hres[3], Sres[3];
      ...
      model NRTL
        import Simulator.Files.Thermodynamic_Functions.*;
        Simulator.Files.Models.gammaNRTL Gamma(Noc = Noc, comp = comp, molFrac = xmol[2, :], T = T), dewGamma(Noc = Noc, comp = comp, molFrac = dewLiqMolFrac, T = T), bublGamma(Noc = Noc, comp = comp, molFrac = xmol[1, :], T = T);
        Real dewLiqMolFrac[Noc], density[Noc];
        Real Cpres[3] "residual specific heat", Hres[3] "residual enthalpy", Sres[3] "residual Entropy", K[Noc], gamma[Noc](each start = 1), gammaBubl[Noc](each start = 1), gammaDew[Noc](each start = 1);
        Real liqfugcoeff_bubl[Noc], vapfugcoeff_dew[Noc], Psat[Noc];
      equation
        gamma = Gamma.gamma;
        for i in 1:Noc loop
          dewLiqMolFrac[i] = xmol[1, i] * Pdew / (gammaDew[i] * Psat[i]);
...
//Note : xmol is the referenced from "Material Stream" model
        r = sum(xmol[2, :] .* R[:]);
        q = sum(xmol[2, :] .* Q[:]);
...
//Bubble Point
        ...
        for i in 1:Noc loop
          if xmol[1, i] == 0 then
            ...
            teta_bubl[i] = xmol[1, i] * Q[i] * (1 / q_bubl);
          end if;
...
//surface volume constant
        ...
        for i in 1:Noc loop
          J[i] = r[i] / sum(r[:] .* xmol[2, :]);
          L[i] = q[i] / sum(q[:] .* xmol[2, :]);
          gammac[i] = exp(1 - J[i] + log(J[i]) + (-5 * q[i] * (1 - J[i] / L[i] + log(J[i] / L[i]))));
        end for;
//=======================================================================================
        for j in 1:k loop
          theta[j] = sum(xmol[2, :] .* q[:] .* e[j, :]) / sum(xmol[2, :] .* q[:]);
        end for;
        for i in 1:k loop
          S[i] = sum(theta[:] .* tau[:, i]);
        end for;
...
//Bubble Point Calculation Routine
        for i in 1:Noc loop
          J_bubl[i] = r[i] / sum(r[:] .* xmol[1, :]);
          L_bubl[i] = q[i] / sum(q[:] .* xmol[1, :]);
          gammac_bubl[i] = exp(1 - J_bubl[i] + log(J_bubl[i]) + (-5 * q[i] * (1 - J_bubl[i] / L_bubl[i] + log(J_bubl[i] / L_bubl[i]))));
        end for;
        for j in 1:k loop
          theta_bubl[j] = sum(xmol[1, :] .* q[:] .* e[j, :]) / sum(xmol[1, :] .* q[:]);
        end for;
        for i in 1:k loop
...
//Liquid_Fugacity Coefficient Calculation Routine
        aML = sum({{xmol[2, i] * xmol[2, j] * aij[i, j] for i in 1:Noc} for j in 1:Noc});
        bML = sum(b .* xmol[2, :]);
        AL = aML * P / (R * T) ^ 2;
        BL = bML * P / (R * T);
        CL[1] = 1;
        ...
        ZLL = min({ZL});
        sum_xaL = {sum({xmol[2, j] * aij[i, j] for j in 1:Noc}) for i in 1:Noc};
...
//Vapour Fugacity Calculation Routine
        aMV = sum({{xmol[3, i] * xmol[3, j] * aij[i, j] for i in 1:Noc} for j in 1:Noc});
        bMV = sum(b .* xmol[3, :]);
        AV = aMV * P / (R * T) ^ 2;
        BV = bMV * P / (R * T);
        CV[1] = 1;
        ...
        ZvV = max({ZV});
        sum_yaV = {sum({xmol[3, j] * aij[i, j] for j in 1:Noc}) for i in 1:Noc};
      ...
      model Grayson_Streed
        ...
        parameter Real Tcg[Noc] = comp.Tc;
...
//Calculation Routine for Liquid Phase Fugacity Coefficient
        S = Solublity_Parameter(Noc, V, Sp, xmol[2, :]);
        for i in 1:Noc loop
          gamma[i] = exp(V[i] * (Sp[i] - S) ^ 2 / (R * T));
        end for;
        liqfugcoeff = Liquid_Fugacity_Coeffcient(Noc, Sp, Tcg, Pc, w, T, P, V, S, gamma);
        for i in 1:Noc loop
          Psat[i] = Simulator.Files.Thermodynamic_Functions.Psat(comp[i].VP, T);
...
//Calculation of Equation of State Constants
        a = EOS_Constants(Noc, Tcg, Pc, T);
        b = EOS_ConstantII(Noc, Tcg, Pc, T);
        a_ij = EOS_ConstantIII(Noc, a);
        amv = EOS_Constant1V(Noc, xmol[3, :], a_ij);
        bmv = sum(xmol[3, :] .* b[:]);
        AG = amv * P / (R_gas * T) ^ 2;
        BG = bmv * P / (R_gas * T);
        for i in 1:Noc loop
...
//==========================================================================================================
    ...
    package Connection
      connector matConn
        Real P, T, Fmol, Hmol, Smol, xfrac[3, Cnoc], Bfrac;
        parameter Integer  Cnoc  annotation(
      ...
      connector trayConn
        Real Fmol, Hmol, xfrac[Cnoc];
        parameter Integer Cnoc;
        annotation(
    ...
    package Models
      model Flash
        ...
        import Simulator.Files.*;
        Real Ftot[3](each min = 0, each start = Fguess);
        Real xmol[3, Noc](start = {xguess,xg,yg}, each min = 0, each max = 1);
        Real Cpcomp[3, Noc];
        Real Hcomp[3, Noc];
        Real Scomp[3, Noc];
        Real Cptot[3];
        Real Htot[3];
        Real Stot[3];
        Real Bliq(min = 0, max = 1, start = Bvapg);
        Real Bvap(min = 0, max = 1, start = Bvapg);
        Real P(min = 0, start = Pguess);
        Real T(min = 0, start = Tg);
        Real Pbubl(start = Pguess, min = 0) "Bubble point pressure";
        Real Pdew(start = Pguess, min = 0) "dew point pressure";
        
        extends Simulator.Guess_Models.Guess_Input;
      equation
//Mole Balance
        Ftot[1] = Ftot[2] + Ftot[3];
        xmol[1, :] .* Ftot[1] = xmol[2, :] .* Ftot[2] + xmol[3, :] .* Ftot[3];
//Bubble point calculation
        Pbubl = sum(gammaBubl[:] .* xmol[1, :] .* exp(comp[:].VP[2] + comp[:].VP[3] / T + comp[:].VP[4] * log(T) + comp[:].VP[5] .* T .^ comp[:].VP[6]) ./ liqfugcoeff_bubl[:]);
//Dew point calculation
        Pdew = 1 / sum(xmol[1, :] ./ (gammaDew[:] .* exp(comp[:].VP[2] + comp[:].VP[3] / T + comp[:].VP[4] * log(T) + comp[:].VP[5] .* T .^ comp[:].VP[6])) .* vapfugcoeff_dew[:]);
        if P >= Pbubl then
          xmol[3, :] = zeros(Noc);
//    sum(xmol[2, :]) = 1;
          Ftot[3] = 0;
...
//VLE region
          for i in 1:Noc loop
//      xmol[3, i] = K[i] * xmol[2, i];
            xmol[2, i] = xmol[1, i] ./ (1 + Bvap * (K[i] - 1));
          end for;
          sum(xmol[2, :]) = 1;
//sum y = 1
        else
...
//Specific Heat and Enthalpy calculation
          Cpcomp[2, i] = Thermodynamic_Functions.LiqCpId(comp[i].LiqCp, T);
          Cpcomp[3, i] = Thermodynamic_Functions.VapCpId(comp[i].VapCp, T);
          Hcomp[2, i] = Thermodynamic_Functions.HLiqId(comp[i].SH, comp[i].VapCp, comp[i].HOV, comp[i].Tc, T);
          Hcomp[3, i] = Thermodynamic_Functions.HVapId(comp[i].SH, comp[i].VapCp, comp[i].HOV, comp[i].Tc, T);
          (Scomp[2, i], Scomp[3, i]) = Thermodynamic_Functions.SId(comp[i].AS, comp[i].VapCp, comp[i].HOV, comp[i].Tb, comp[i].Tc, T, P, xmol[2, i], xmol[3, i]);
        end for;
        for i in 2:3 loop
          Cptot[i] = sum(xmol[i, :] .* Cpcomp[i, :]) + Cpres[i];
          Htot[i] = sum(xmol[i, :] .* Hcomp[i, :]) + Hres[i];
          Stot[i] = sum(xmol[i, :] .* Scomp[i, :]) + Sres[i];
        end for;
        Cptot[1] = Bliq * Cptot[2] + Bvap * Cptot[3];
        Cpcomp[1, :] = xmol[1, :] .* Cptot[1];
        Htot[1] = Bliq * Htot[2] + Bvap * Htot[3];
        Hcomp[1, :] = xmol[1, :] .* Htot[1];
        Stot[1] = Bliq * Stot[2] + Bvap * Stot[3];
        Scomp[1, :] = xmol[1, :] * Stot[1];
...
//=============================================================================================
  ...
  package Streams
    model Material_Stream
      ...
      parameter Integer Noc;
      parameter Simulator.Files.Chemsep_Database.General_Properties comp[Noc];
      Real P(start = Pguess) "Pressure";
      Real T(start = Tg) "Temperature";
      Real Pbubl(start = Pmin) "Bubble point pressure", Pdew(start = Pmax) "dew point pressure";
      Real Bliq(start = Bliqg) "Liquid Phase mole fraction", Bvap(start = Bvapg) "Vapor Phase mole fraction";
      Real Bmliq(start = Bliqg) "Liquid Phase mass fraction", Bmvap(start = Bvapg) "Vapor Phase Mass fraction";
      Real Ftot[3](start = {Fguess, Fliqg,Fvapg}) "Total molar flow";
      Real Mtot[3] "Total Mass Flow", Mavg[3] "Average Molecular weight of Phases";
      Real xmol[3, Noc](start = {xguess,xg,yg}, each min = 0, each max = 1) "Component mole fraction";
      Real xmass[3, Noc](start = {xguess, xg, yg}, each min = 0, each max = 1) "Component Mass fraction";
      Real Fcomp[3, Noc](each start = Fguess, each min = 0) "Component Molar flow";
      Real Mcomp[3, Noc](each min = 0, each start = 100) "Component Mass Fraction";
      Real Cptot[3](start={Hmixg, Hliqg, Hvapg})"phase Molar Specific Heat";
      Real Cpcomp[3, Noc] "Component Molar Specific Heat";
      Real Htot[3](start = {Hmixg, Hliqg, Hvapg}) "Phase Molar Enthalpy";
      Real Hcomp[3, Noc] "Component Molar Enthalpy";
      Real Stot[3] "Phase Molar Entropy";
      Real Scomp[3, Noc] "Component Molar Entropy";
      
      
      Simulator.Files.Connection.matConn inlet(Cnoc = Noc) annotation(
        Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Simulator.Files.Connection.matConn outlet(Cnoc = Noc) annotation(
        Placement(visible = true, transformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)),
        HideResult = "true");
...
//below bubble point region
        xmass[3, :] = zeros(Noc);
        Mcomp[1, :] = xmass[1, :] .* Mtot[1];
        xmass[2, :] = xmass[1, :];
      elseif P >= Pdew then
        for i in 1:Noc loop
          Mcomp[:, i] = xmass[:, i] .* Mtot[:];
        end for;
      else
//above dew point region
        xmass[2, :] = zeros(Noc);
...
//Specific Heat and Enthalpy calculation
      ...
      Scomp[1, :] = xmol[1, :] * Stot[1];
//Bubble point calculation
      Pbubl = sum(gammaBubl[:] .* xmol[1, :] .* Psat[:] ./ liqfugcoeff_bubl[:]);
//Dew point calculation
      Pdew = 1 / sum(xmol[1, :] ./ (gammaDew[:] .* Psat[:]) .* vapfugcoeff_dew[:]);
      if P >= Pbubl then
//below bubble point region
        xmol[3, :] = zeros(Noc);
//    sum(xmol[2, :]) = 1;
  ...
  package Unit_Operations
    model Mixer
      ...
      //Inlet Stream Variables
       Real Pin[NI](start = Pguess,each unit="Pa");
       Real xin[NI, Noc]( each min = 0, each max = 1) "Input stream component mol fraction"; 
       Real Fin[NI](each min = 0, each start = Fguess) "Input stream Molar Flow";  
       Real Hin[NI] "Inlet molar enthalpy of each stream";
       Real Tin[NI](each min = 0, each start = Tg) "Temperature of each stream";
       Real Sin[NI] "Inlet molar enthalpy of each stream";
       Real Bin[NI](each min = 0, each max = 1, each start = Bvapg) "Inlet vapor phase mol fraction";
       
       //Model Parameters
       parameter String Pexit;
      //Outlet Stream Variables
       Real Pout(start = Pguess);
       Real xout[Noc](each min = 0, each max = 1, start = xguess) "Output Stream component mol fraction";
       Real Fout(each min = 0, start = Fguess) "Output stream Molar Flow";  
       Real Hout "Outlet molar enthalpy"; 
       Real Tout(start = Tg) "Temperature of outlet stream"; 
       Real Sout "Outlet molar entropy";
       Real Bout(min = 0, max = 1, start = Bvapg) "Outlet vapor phase mol fraction";
      //================================================================================
      
      //Input and Output Connectors
      Simulator.Files.Connection.matConn outlet(Cnoc = Noc) annotation(
        Placement(visible = true, transformation(origin = {100, -2}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Simulator.Files.Connection.matConn inlet[NI](each Cnoc = Noc) annotation(
        Placement(visible = true, transformation(origin = {-100, -2}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      
      //Extension of Initial guess generation model
      extends Guess_Models.Initial_Guess;
...
//===================================================================================
//Output Pressure
      if Pexit == "Inlet_Minimum" then
        Pout = min(Pin);
      elseif Pexit == "Inlet_Average" then
        Pout = sum(Pin) / NI;
      elseif Pexit == "Inlet_Maximum" then
        Pout = max(Pin);
      end if;
//Molar Balance
      Fout = sum(Fin[:]);
      for i in 1:Noc loop
        xout[i] * Fout = sum(xin[:, i] .* Fin[:]);
      end for;
//Energy balance
      Hout = sum(Hin[:] .* Fin[:] / Fout);
    end Mixer;
    ...
    model Heater
      ...
      //Inlet Stream Variables
      Real Fin(start = Fguess) "inlet mixture molar flow rate";
      Real Tin(start = Tg) "Inlet Temperature";
      Real Pin(start = Pguess) "Inlet pressure";
      Real Hin(start = Htotg) "inlet mixture molar enthalpy";
      Real Fout(start = Fguess) "outlet mixture molar flow rate";
      Real xin[Noc](each min = 0, each max = 1, start = xguess) "mixture mole fraction";
      Real Bin(min = 0, max = 1, start = Bvapg) "Inlet vapor phase mole fraction";
      
      //Model Variables
      Real Qadd "Heat added";
      Real Deltat "Temperature Increase";
      parameter Real Deltap "Pressure drop";
      parameter Real Eff "Efficiency";
      
      //Outlet Stream Variables
      Real Pout(start = Pguess) "Outlet pressure";
      Real Tout(start = Tg) "Outlet Temperature";
      Real Bout(min = 0, max = 1, start = Bvapg) "Outlet Vapor Mole Fraction";
      Real Hout(start = Htotg) "outlet mixture molar enthalpy";
      //========================================================================================
       //Inlet and Oulet Connectors
      //========================================================================================
      Simulator.Files.Connection.matConn inlet(Cnoc= Noc) annotation(
        Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Simulator.Files.Connection.matConn outlet(Cnoc= Noc) annotation(
...
//temperature calculation
    ...
    model Heat_Exchanger
      ...
      //      Inputs : deltap_hot,deltap_cold,Heat_Loss,Tcout1,Flow Direction,Name of the calculation type,A
      //Mode-II - Estimation of Cold Fluid Outlet Temperature
      //      Inputs : deltap_hot,deltap_cold,Heat_Loss,Houtt,Flow Direction,Name of the calculation type,A
      //Mode-III - Estimation of Both the fluid outlet temperature
      //      Inputs : deltap_hot,deltap_cold,Heat_Loss,Qact,Flow Direction,Name of the calculation type,A
      //Mode-IV - Estimation of both the fluid outlet temperature-NTU Method
      //      Inputs : deltap_hot,deltap_cold,Heat_Loss,U,Flow Direction,Name of the calculation type,A
      //Mode-V-Estimation of Heat Transfer A
      ...
      //      Inputs : deltap_hot,deltap_cold,Heat_Loss,U,Eff,Flow Direction,Name of the calculation type
      import Simulator.Files.*;
      import Simulator.Files.Thermodynamic_Functions.*;
      parameter Simulator.Files.Chemsep_Database.General_Properties comp[Noc];
      parameter Integer Noc "number of compounds ";
      Simulator.Files.Connection.matConn Hot_In(Cnoc = Noc) annotation(
      ...
      Simulator.Files.Connection.matConn Hot_Out(Cnoc = Noc) annotation(
      ...
      Simulator.Files.Connection.matConn Cold_In(Cnoc = Noc) annotation(
      ...
      Simulator.Files.Connection.matConn Cold_Out(Cnoc = Noc) annotation(
      ...
      //Variables
      //Hot Stream Inlet
      Real Phin(start=Pguess), Thin(start=Tg), Fhin[1](start=Fguess), Hhin(start=Htotg), Shin, xhin[2, Noc](start={xguess,xguess}), Bhin(start=Bvapg);
      //Hot Stream Outlet
      Real Phout(start=Pguess), Thout(start=Tg), Fhout[1](start=Fguess), Hhout(start=Htotg), Shout, xhout[2, Noc](start={xguess,xguess}), Bhout(start=Bvapg);
      //Cold Stream Inlet
      Real Pcin(start=Pguess), Tcin(start=Tg), Fcin[1](start=Fguess), Hcin(start=Htotg), Scin, xcin[2, Noc](start={xguess,xguess}), Bcin(start=Bvapg);
      //Cold Stream Outlet
      Real Pcout(start=Pguess), Tcout1(start=Tg), Tcout2(start=Tg), Fcout[1](start=Fguess), Hcout(start=Htotg), Scout, xcout[2, Noc](start={xguess,xguess}), Bcout(start=Bvapg);
    
    //Model Variables
      Real Qact "Actual Heat Load";
      Real Qmax, Qhmax, Qcmax;
      
      //Hot Stream Enthalpy at Cold Stream Inlet Temperature
      Real Hcomph[2, Noc](start={Htotg,Htotg});
      Real Htoth[3](start=Htotg);
      //Cold Stream Enthalpy at Hot Stream Inlet Temperature
      Real Hcompc[2, Noc](start={Htotg,Htotg});
      Real Htotc[3](start=Htotg);
      Real Deltah;
      //Heat Exchanger Effeciency
      Real Eff;
      //LMTD
      Real DelT1(start = 20), DelT2(start = 10);
...
//Hot Stream Inlet
      ...
      Hot_In.Hmol = Hhin;
      Hot_In.Smol = Shin;
      Hot_In.xfrac[1, :] = xhin[1, :];
      Hot_In.xfrac[2, :] = xhin[2, :];
      Hot_In.Bfrac = Bhin;
//Hot Stream Outlet
      Hot_Out.P = Phout;
      Hot_Out.T = Thout;
      Hot_Out.Fmol = Fhout[1];
      Hot_Out.Hmol = Hhout;
      Hot_Out.Smol = Shout;
      Hot_Out.xfrac[1, :] = xhout[1, :];
      Hot_Out.xfrac[2, :] = xhout[2, :];
      Hot_Out.Bfrac = Bhout;
//Cold Stream In
      Cold_In.P = Pcin;
      Cold_In.T = Tcin;
      ...
      Cold_In.Hmol = Hcin;
      Cold_In.Smol = Scin;
      Cold_In.xfrac[1, :] = xcin[1, :];
      Cold_In.xfrac[2, :] = xcin[2, :];
      Cold_In.Bfrac = Bcin;
//Cold Stream Out
      Cold_Out.P = Pcout;
      Cold_Out.T = Tcout2;
      Cold_Out.Fmol= Fcout[1];
      Cold_Out.Hmol = Hcout;
      Cold_Out.Smol = Scout;
      Cold_Out.xfrac[1, :] = xcout[1, :];
      Cold_Out.xfrac[2, :] = xcout[2, :];
      Cold_Out.Bfrac = Bcout;
    equation
      Fhin[1] = Fhout[1];
      Fcin[1] = Fcout[1];
      xhin[1] = xhout[1];
      xcin[1] = xcout[1];
      Phout = Phin - deltap_hot;
      Pcout = Pcin - deltap_cold;
      Qact = Fcin[1] * (Hcout - Hcin);
      Deltah = -(Qact + Heat_Loss * 1000) / Fhin[1];
      if Calculation_Method == "BothOutletTemp(UA)" then
        Hhout = Hhin - Qact / Fhin[1] - Heat_Loss * 1000 / Fhin[1];
        Tcout1 = Tcin + Effc * (Thin - Tcin);
      else
        Tcout1 = Tcout2;
        Hhout = Hhin + Deltah;
      end if;
...
//Calculation of Hot Stream Enthalpy at  Cold Stream Inlet Temperature
      for i in 1:Noc loop
        Hcomph[1, i] = Thermodynamic_Functions.HLiqId(comp[i].SH, comp[i].VapCp, comp[i].HOV, comp[i].Tc, Tcin);
        Hcomph[2, i] = Thermodynamic_Functions.HVapId(comp[i].SH, comp[i].VapCp, comp[i].HOV, comp[i].Tc, Tcin);
      end for;
      for i in 1:2 loop
        Htoth[i] = sum(xhin[i, :] .* Hcomph[i, :]);
/*+ inResMolEnth[2, i]*/
      end for;
      Htoth[3] = (1 - Bhin) * Htoth[1] + Bhin * Htoth[2];
//Maximum Theoritical Heat Exchange-Hot Fluid
      Qhmax = Fhin[1] * (Hhin - Htoth[3]);
//===========================================================================================================
//Enthalpy of Cold Stream Enthalpy at Hot Fluid Inlet Temperature
      for i in 1:Noc loop
        Hcompc[1, i] = Thermodynamic_Functions.HLiqId(comp[i].SH, comp[i].VapCp, comp[i].HOV, comp[i].Tc, Thin);
        Hcompc[2, i] = Thermodynamic_Functions.HVapId(comp[i].SH, comp[i].VapCp, comp[i].HOV, comp[i].Tc, Thin);
      end for;
      for i in 1:2 loop
        Htotc[i] = sum(xcin[i, :] .* Hcompc[i, :]);
/*+ inResMolEnth[1, i]*/
      end for;
      Htotc[3] = (1 - Bcin) * Htotc[1] + Bcin * Htotc[2];
//Maximum Theoritical Heat Exchange- Cold Fluid
      Qcmax = Fcin[1] * abs(Hcin - Htotc[3]);
//Maximum Heat Exchange
      Qmax = min(Qhmax, Qcmax);
      Eff = (Qact - Heat_Loss * 1000) / Qmax * 100;
...
//==========================================================================================================
//NTU-Method
      Cpcold = Fcin[1] * ((Hcout - Hcin) / (Tcout1 - Tcin));
      Cphot = Fhin[1] * ((Hhout - Hhin) / (Thout - Thin));
...
//Heat Capacity Ratio for Hot and Cold Side
    ...
    model Cooler
      ...
      //Model Variables
      Real Deltat "Temperature Drop", Qrem "Heat removed";
      parameter Real Deltap "Pressure drop", Eff "Efficiency";
      
      //Output Variables
      Real Fout(start = Fguess) "outlet mixture molar flow rate";
      Real Pout(min = 0, start = Pguess) "Outlet pressure"; 
      Real Tout(start = Tg) "Outlet Temperature";
      Real Bout(min = 0, max = 1, start = Bvapg) "Outlet Vapor Mole Fraction";
      Real Hout(start = Htotg) "outlet mixture molar enthalpy";
      Real Sout "outlet mixture molar entropy";
      Real xc[Noc](each min = 0, each max = 1, start = xguess) "mixture mole fraction";
      //========================================================================================
      Files.Connection.matConn inlet(Cnoc = Noc) annotation(
        Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Simulator.Files.Connection.matConn outlet(Cnoc = Noc) annotation(
        Placement(visible = true, transformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Simulator.Files.Connection.enConn energy annotation(
...
//temperature calculation
    ...
    model Valve
      ...
      Real Hout(start=Htotg) "outlet mixture molar enthalpy";
      Real Sout "outlet mixture molar entropy";
      Real xvalv[Noc](each min = 0, each max = 1, start = xguess) "mixture mole fraction";
      Real Bout(min = 0, max = 1, start = Bvapg) "Outlet vapor phase mole fraction";
      //========================================================================================
      //Instantiation of Guess Model
      extends Guess_Models.Initial_Guess;
      //========================================================================================
...
//temperature calculation
    ...
    //================================================================================================
      ...
      Real Fmol[3](start=Fguess);
      Real xmol[3, Noc](start={xguess,xg,yg}, each min = 0, each max = 1);
      Real Hmol[3](start=Htotg);
      Real Hcompv[Noc], Hcompl[Noc];
      Real Smol[3];
      Real Bfrac[3](each min = 0, each max = 1, each start = Bvapg);
      Real P(min = 0, start = Pguess), T(min = 0, start = Tg);
      Real xmolt[3, Noc](each min = 0, each max = 1,start={xguess,xguess,xguess});
      Real xliq[Noc](each min = 0, each max = 1, start=xguess), xvap[Noc](each min = 0, each max = 1,start=xguess);
      
      //Model Variables
      parameter Integer HKey, LKey;
      Real Nm(min = 0, start = 10),Nact,Nfeed ;
      Real Alph[Noc], theta(start = 1);
      Real Rm(start=1),Ract;
      Real xs, ys;
      Real Pvr[Noc],Pvc[Noc];
    
      //Condenser Specifications
      parameter String Cond = "Total";
      Real Hcondl(start=Htotg), Hcondv(start=Htotg);
      Real Qcond;
      Real Tcnd(start = Tg),Pcnd(start = Pguess);
      
      //Reboiler Specifications
      Real Qreb;
      Real Treb(start = Tg),Preb(start =Pguess);
      
      //Stripping and Rectifying Section flows
      Real Pdew(start=Pguess), Pbubl(start=Pguess);
      Real Frectl(start=Fguess), Frectv(start=Fguess);
      Real Fstrpl(start=Fguess), Fstrpv(start=Fguess);
    //=============================================================================================================
     
      Simulator.Files.Connection.matConn feed(Cnoc = Noc) annotation(
      ...
      Simulator.Files.Connection.matConn distillate(Cnoc = Noc) annotation(
      ...
      Simulator.Files.Connection.matConn bottoms(Cnoc = Noc) annotation(
...
//=================================================================================================
      ...
      bottoms.T = Treb;
      bottoms.Fmol = Fmol[2];
      bottoms.xfrac[1, :] = xmol[2, :];
      bottoms.Hmol = Hmol[2];
      bottoms.Smol = Smol[2];
      bottoms.Bfrac = Bfrac[2];
//================================================================================================
      distillate.P = Pcnd;
      distillate.T = Tcnd;
      distillate.Fmol = Fmol[3];
      distillate.xfrac[1, :] = xmol[3, :];
      distillate.Hmol = Hmol[3];
      distillate.Smol = Smol[3];
      distillate.Bfrac = Bfrac[3];
      reboiler_duty.Qflow = Qreb;
      condenser_duty.Qflow = Qcond;
//===========================================================================================================
//Adjustment for thermodynamic packages
      xmolt[1, :] = xmol[1, :];
      xmolt[2, :] = xmol[1, :] ./ (1 .+ Bfrac[1] .* (K[:] .- 1));
      for i in 1:Noc loop
        xmolt[3, i] = K[i] * xmol[2, i];
      end for;
//==============================================================================================================
//Bubble point calculation
      Pbubl = sum(gammaBubl[:] .* xmol[1, :] .* Psat[:] ./ liqfugcoeff_bubl[:]);
//Dew point calculation
    ...
    equation
     ...
     for i in 1:Noc loop
        Pvc[i] = Simulator.Files.Thermodynamic_Functions.Psat(comp[i].VP, Tcnd);
        Pvr[i] = Simulator.Files.Thermodynamic_Functions.Psat(comp[i].VP, Treb);
      end for;
      ...
      for i in 1:Noc loop
        if xmol[1, i] == 0 then
          ...
          Fmol[1] .* xmol[1, i] = Fmol[2] .* xmol[2, i] + Fmol[3] .* xmol[3, i];
        end if;
      end for;
      sum(xmol[3, :]) = 1;
      sum(xmol[2, :]) = 1;
      for i in 1:Noc loop
        if i <> HKey then
          if Cond == "Total" then
            xmol[3, i] / xmol[3, HKey] = Alph[i] ^ Nm * (xmol[2, i] / xmol[2, HKey]);
          elseif Cond == "Partial" then
            xmol[3, i] / xmol[3, HKey] = Alph[i] ^ (Nm + 1) * (xmol[2, i] / xmol[2, HKey]);
          end if;
        end if;
      end for;
      Alph[:] = K[:] / K[HKey];
...
//Case-I -Corner Point on Condenser and Reboiler
      if Tcnd <= 0 and Treb <= 0 then
        if Cond == "Partial" then
          1 / Pcnd = sum(xmol[3, :] ./ (gamma[:] .* exp(comp[:].VP[2] + comp[:].VP[3] / 1 + comp[:].VP[4] * 1 + comp[:].VP[5] .* Tcnd .^ comp[:].VP[6])));
          Preb = sum(gamma[:] .* xmol[2, :] .* exp(comp[:].VP[2] + comp[:].VP[3] / 1 + comp[:].VP[4] * 1 + comp[:].VP[5] .* Treb .^ comp[:].VP[6]));
        elseif Cond == "Total" then
          Pcnd = sum(gamma[:] .* xmol[3, :] .* exp(comp[:].VP[2] + comp[:].VP[3] / 1 + comp[:].VP[4] * 1 + comp[:].VP[5] .* Tcnd .^ comp[:].VP[6]));
          Preb = sum(gamma[:] .* xmol[2, :] .* exp(comp[:].VP[2] + comp[:].VP[3] / 1 + comp[:].VP[4] * 1 + comp[:].VP[5] .* Treb .^ comp[:].VP[6]));
        end if;
//==============================================================================================================
      elseif Tcnd <= 0 then
...
//================================================================================================================
      elseif Treb <= 0 then
        if Cond == "Partial" then
          1 / Pcnd = sum(xmol[3, :] ./ (gamma[:] .* exp(comp[:].VP[2] + comp[:].VP[3] / Tcnd + comp[:].VP[4] * log(Tcnd) + comp[:].VP[5] .* Tcnd .^ comp[:].VP[6])));
          Preb = sum(gamma[:] .* xmol[2, :] .* exp(comp[:].VP[2] + comp[:].VP[3] / 1 + comp[:].VP[4] * 1 + comp[:].VP[5] .* Treb .^ comp[:].VP[6]));
        elseif Cond == "Total" then
          Pcnd = sum(gamma[:] .* xmol[3, :] .* exp(comp[:].VP[2] + comp[:].VP[3] / Tcnd + comp[:].VP[4] * log(Tcnd) + comp[:].VP[5] .* Tcnd .^ comp[:].VP[6]));
          Preb = sum(gamma[:] .* xmol[2, :] .* exp(comp[:].VP[2] + comp[:].VP[3] / 1 + comp[:].VP[4] * 1 + comp[:].VP[5] .* Treb .^ comp[:].VP[6]));
        end if;
//============================================================================================================
      else
        if Cond == "Partial" then
          1 / Pcnd = sum(xmol[3, :] ./ (gamma[:] .* Pvc[:]));
          Preb = sum(gamma[:] .* xmol[2, :] .* Pvr[:]);
        elseif Cond == "Total" then
          Pcnd = sum(gamma[:] .* xmol[3, :] .* Pvc[:]);
          Preb = sum(gamma[:] .* xmol[2, :] .* Pvr[:]);
        end if;
      end if;
//================================================================================================================
//Minimum Reflux, Underwoods method
      if theta > Alph[LKey] or theta < Alph[HKey] then
        0 = sum(Alph[:] .* xmol[1, :] ./ (Alph[:] .- theta));
//This is mathamatical adjustment for right convergence of theta
      else
        Bfrac[1] = sum(Alph[:] .* xmol[1, :] ./ (Alph[:] .- theta));
      end if;
      Rm + 1 = sum(Alph[:] .* xmol[3, :] ./ (Alph[:] .- theta));
//================================================================================================================
...
// Feed location, Fenske equation
      Nfeed = Nact / Nm * log(xmol[1, LKey] / xmol[1, HKey] * (xmol[2, HKey] / xmol[2, LKey])) / log(K[LKey] / K[HKey]);
//===============================================================================================================
//Rectifying and Stripping flows
      Frectl = Ract * Fmol[3];
      Fstrpl = (1 - Bfrac[1]) * Fmol[1] + Frectl;
      Fstrpv = Fstrpl - Fmol[2];
      Frectv = Bfrac[1] * Fmol[1] + Fstrpv;
      for i in 1:Noc loop
      Hcompv[i]=Simulator.Files.Thermodynamic_Functions.HVapId(comp[i].SH, comp[i].VapCp, comp[i].HOV, comp[i].Tc, Tcnd);
      Hcompl[i]=Simulator.Files.Thermodynamic_Functions.HLiqId(comp[i].SH, comp[i].VapCp, comp[i].HOV, comp[i].Tc, Tcnd);
      end for;
//==========================================================================================================
      if Cond == "Total" then
        Hcondl = Hmol[3];
      elseif Cond == "Partial" then
        Hcondl = sum(xliq[:] .* Hcompl[:]);
      end if;
      Hcondv = sum(xvap[:] .* Hcompv[:]);
      Frectv .* xvap[:] = Frectl .* xliq[:] + Fmol[3] .* xmol[3, :];
      if Cond == "Partial" then
        xmol[3, :] = K[:] .* xliq[:];
      elseif Cond == "Total" then
        xmol[3, :] = xliq[:];
...
//=============================================================================================================
//Energy Balance
      Fmol[1] * Hmol[1] + Qreb - Qcond = Fmol[2] * Hmol[2] + Fmol[3] * Hmol[3];
      Frectv * Hcondv = Qcond + Fmol[3] * Hmol[3] + Frectl * Hcondl;
      annotation(
    ...
    model Compound_Separator
      ...
      parameter Integer Noc "Number of components", Stream "Specified Stream";
      parameter Simulator.Files.Chemsep_Database.General_Properties comp[Noc] "Components array";
      
      //Input Variables
      Real Pin(start = Pguess) "inlet pressure";
      Real Tin(start = Tg) "inlet temperature";
      Real xin[Noc](each min = 0, each max = 1, start = xguess) "inlet mixture mole fraction";
      Real Fin(start = Fguess) "inlet mixture molar flow";
      Real Fcompi[Noc](each min = 0, each start = Fguess) "inlet compound molar flow";
      Real Mcompi[Noc](each min = 0, each start = Fguess) "inlet compound mass flow";
      Real Hin(start = Htotg) "inlet mixture molar enthalpy";
      
      //Output Variables
      Real Pout[2](each min = 0, start = {Pguess, Pguess}) "Outlet Pressure";
      Real Tout[2](start={Tg, Tg}) "outlet temperature";
      Real xout[2, Noc](each min = 0, each max = 1, start =xguess) "outlet mixture mole fraction";
      Real Fout[2](each min = 0, each start = Fguess) "Outlet mixture molar flow";
      Real Fcompo[2, Noc](each min = 0, each start = Fguess) "outlet compounds molar flow";
      Real Mcompo[2, Noc](each min = 0, each start =Fguess) "outlet compound mass flow";
      Real Hout[2](start={Htotg,Htotg}) "outlet mixture molar enthalpy";
      
      //Model Variables
      Real Qflow "energy required";
      Real Sval[Noc] "Separation factor value";
      parameter String Sfact[Noc] "Separation factor";
      
      //Separation factor: Molar_Flow, Mass_Flow, Inlet_Molar_Flow_Percent, Inlet_Mass_Flow_Percent.
      Simulator.Files.Connection.matConn inlet(Cnoc = Noc) annotation(
        Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Simulator.Files.Connection.matConn outlet1(Cnoc = Noc) annotation(
      ...
      Simulator.Files.Connection.matConn outlet2(Cnoc = Noc) annotation(
        Placement(visible = true, transformation(origin = {100, -70}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
// Connector equation
      ...
      outlet1.T = Tout[1];
      outlet1.Fmol = Fout[1];
      outlet1.xfrac[1, :] = xout[1, :];
      outlet1.Hmol = Hout[1];
      
      outlet2.Fmol = Fout[2];
      outlet2.xfrac[1, :] = xout[2, :];
      outlet2.Hmol = Hout[2];
      outlet2.P = Pout[2];
      outlet2.T = Tout[2];
...
//================================================================================
    // Mole balance
      Fin = sum(Fout[:]);
      Fcompi[:] = xout[1, :] * Fout[1] + xout[2, :] * Fout[2];
//===================================================================================
    // Conversion
      Fcompi = xin .* Fin;
      Mcompi = Fcompi .* comp[:].MW;
      for i in 1:2 loop
        Fcompo[i, :] = xout[i, :] .* Fout[i];
        Mcompo[i, :] = Fcompo[i, :] .* comp[:].MW;
      end for;
      sum(xout[2, :]) = 1;
      for i in 1:Noc loop
        if Sfact[i] == "Molar_Flow" then
          Sval[i] = Fcompo[Stream, i];
        elseif Sfact[i] == "Mass_Flow" then
          Sval[i] = Mcompo[Stream, i];
        elseif Sfact[i] == "Inlet_Molar_Flow_Percent" then
          Fcompo[Stream, i] = Sval[i] * Fcompi[i] / 100;
        elseif Sfact[i] == "Inlet_Mass_Flow_Percent" then
          Mcompo[Stream, i] = Sval[i] * Mcompi[i] / 100;
        end if;
      end for;
//===========================================================================================
    //Energy balance
      Qflow = sum(Hout .* Fout) - Fin * Hin;
      annotation(
    ...
    model Flash
      ...
      //Model Variables
      Real T(start = Tg), P(start = Pguess);
      Real Pbubl(start = Pmin) "Bubble point pressure", Pdew(start = Pmax) "dew point pressure";
      Real Ftot[3](start =Fguess);
      Real xmol[3, Noc](each min = 0, each max = 1, start = {xguess,xguess,xguess});
      ...
      Simulator.Files.Connection.matConn feed(Cnoc = Noc) annotation(
        Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Simulator.Files.Connection.matConn vapor(Cnoc = Noc) annotation(
      ...
      Simulator.Files.Connection.matConn liquid(Cnoc = Noc) annotation(
      ...
      //Instantiation of Initial Guess Model
      extends Guess_Models.Initial_Guess;
...
//Connector equation
      ...
      liquid.P = P;
      liquid.Fmol = Ftot[2];
      liquid.xfrac[1, :] = xmol[2, :];
      
      vapor.T = T;
      vapor.P = P;
      vapor.Fmol = Ftot[3];
      vapor.xfrac[1, :] = xmol[3, :];
//==================================================================================================
    //Mole Balance
      Ftot[1] = Ftot[2] + Ftot[3];
      xmol[1, :] .* Ftot[1] = xmol[2, :] .* Ftot[2] + xmol[3, :] .* Ftot[3];
...
//Phase molar fractions
    ...
    model Splitter
      ...
      //Output variables
      Real Pout[NO](start = {Pguess,Pguess}) "Outlet Pressure";
      Real Tout[NO](start = {Tg,Tg}) "Outlet Temperature";
      Real xout[NO, Noc](each min = 0, each max = 1, start = {xguess,xguess}) "Outlet Mixture Molar Fraction";
      Real Fout[NO](each min = 0, start = Fguess) "Outlet Mixture Molar Flow";
      Real Mout[NO](each min = 0, each start = Fguess) "Outlet Mixture Mass Flow";
      
      Real Srat[NO] "Split ratio";
      Real Sval[NO] "Specification value";
      Real MW "Stream molecular weight";
    
      parameter String Ctype "Split_Ratio, Mass_Flow or Molar_Flow";
     
      Simulator.Files.Connection.matConn inlet(Cnoc = Noc) annotation(
        Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Simulator.Files.Connection.matConn outlet[NO](each Cnoc = Noc) annotation(
        Placement(visible = true, transformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
//Connector equations
      ...
      for i in 1:NO loop
        outlet[i].P = Pout[i];
        outlet[i].T = Tout[i];
        outlet[i].xfrac[1, :] = xout[i, :];
        outlet[i].Fmol = Fout[i];
      end for;

    //Specification value assigning equation
      if Ctype == "Split_Ratio" then
        Srat[:] = Sval[:];
      elseif Ctype == "Molar_Flow" then
        Fout[:] = Sval[:];
      elseif Ctype == "Mass_Flow" then
        Mout[:] = Sval[:];
      end if;
//Balance equation
      for i in 1:NO loop
    ...
    model Centrifugal_Pump
      ...
      Real Hout(start =Htotg) "Outlet Mixture Molar Enthalpy";
      Real Dens(min = 0) "Density";
      Real Pv(start = Pguess) "Vapor pressure of Mixture at outlet Temperature";
      
      //Model Variables
      Real Preq "Power required";
      Real Deltat "Temperature increase";
      Real Deltap "Pressure Increase";
      Real NPSH "NPSH";
    
    
    
      Real Densc[Noc](each min = 0) "Component density";
...
//vap pressure of mixture at Tout
    ...
    model Adiabatic_Compressor
      ...
      Real Hin(start = Htotg) "inlet mixture molar enthalpy";
      Real Sin "inlet mixture molar entropy";
      Real Bin(min = 0, max = 1, start = Bvapg) "Inlet vapor mol fraction";
      ...
      //Model Variables
      Real Preq "required Power";
      Real xcmps[Noc](each min = 0, each max = 1, start = xguess) "mixture mole fraction";
      Real Deltap "Pressure Increase";
      Real Deltat "Temperature increase";
...
//=============================================================================================
      Fin = Fout;
//material balance
      Hout = Hin + (Htot[1] - Hin) / Eff;
      Preq = Fin * (Htot[1] - Hin) / Eff;
//energy balance
      Pin + Deltap = Pout;
//pressure calculation
      Tin + Deltat = Tout;
...
//ideal flash
    ...
    model Adiabatic_Expander
      ...
      //Model Variables
      Real Pgen "generated Power";
      Real Deltap "Pressure Drop";
      Real Deltat "Temperature increase";
      Real xexp[Noc](start = xguess) "mixture mole fraction";
...
//connector equations
      ...
      inlet.T = Tin;
      inlet.mixMolFlo = Fin;
      inlet.mixMolEnth = Hin;
      inlet.mixMolEntr = Sin;
      inlet.xfrac[1, :] = xexp[:];
      inlet.vapPhasMolFrac = Bin;
      outlet.P = Pout;
      outlet.T = Tout;
      outlet.mixMolFlo = Fout;
      outlet.mixMolEnth = Hout;
      outlet.mixMolEntr = Sout;
      outlet.xfrac[1, :] = xexp[:];
      outlet.vapPhasMolFrac = Bout;
      energy.enFlo = Pgen;
//=============================================================================================
      Fin = Fout;
//material balance
      Hout = Hin + (Htot[1] - Hin) * eff;
      Pgen = Fin * (Htot[1] - Hin) * eff;
//energy balance
      Pin - Deltap = Pout;
//pressure calculation
      Tin - Deltat = Tout;
...
//ideal flash
    ...
    model Conversion_Reactor
      ...
      parameter String Cmode = "Isothermal" 
      "Isothermal, Define_Outlet_Temperature, Adiabatic; choose the required operation";
      //Input Variables
      Real Fin(start = Fguess) "Inlet Molar Flowrate";
      Real xin[Noc](each min = 0, each max = 1, start = xguess) "Inlet component Mole Fraction";
      Real Hin "Inlet Molar Enthalpy";
      Real Pin(start = Pguess) "Inlet pressure";
      Real Tin(start = Tg) "Inlet Temperature";
      
      //Output Variables
      Real Fout(start = Fguess) "Outlet Molar Flowrate";
      Real xout[Noc](each min = 0, each max = 1, start = xguess) "Outlet component Mole Fraction";
      Real Hout "Outlet Molar Enthalpy";
      Real Pout(start = Pguess) "Outlet pressure";
      Real Tout(start = Tg) "Outlet Temperature";
      ...
      parameter Real Deltap = 0 "Pressure drop";
    ...
    //Reactor equations
      for i in 1:Noc loop
        N[i, 1] = Fin * xin[i] - Sc[i, 1] / Sc[Bc[1], 1] * Fin * xin[Bc[1]] * X[1];
      end for;
      if Nr > 1 then
        for j in 2:Nr loop
          for i in 1:Noc loop
            N[i, j] = N[i, j - 1] - Sc[i, j] / Sc[Bc[j], j] * Fin * xin[Bc[j]] * X[j];
          end for;
        end for;
      end if;
      Fout = sum(N[:, Nr]);
      ...
      Pin - Deltap = Pout;
      if Cmode == "Isothermal" then
        Tin = Tout;
        energy.Qflow = Hout * Fout - Hin * Fin;
      elseif Cmode == "Adiabatic" then
        Hout * Fout = Hin * Fin;
        energy.Qflow = 0;
      elseif Cmode == "Define_Outlet_Temperature" then
        Tout = Tdef;
        energy.Qflow = Hout * Fout - Hin * Fin;
      end if;
      annotation(
    ...
    package PF_Reactor
      model PFR
        ...
        Real T(min = 0, start = Tg) "Inlet Temperature";
        Real P(min = 0, start = Pguess) "Inlet pressure";
        //Component Molar Flow rates of respective phases
        Real Fcomp[3, Noc](each min = 0, each start = Fguess);
        //Total molar flow rates of respective phases
        Real Ftot[3](each min = 0, each start =Fguess) "Total inlet molar flow rate";
        //Mole Fraction of components in respective phases
        Real xin[3, Noc](each min = 0, each max = 1,  start = {xguess,xguess,xguess}) "Mole Fraction of components in inlet stream";
        Real Hin, Sin, Bin(min = 0, max = 1, start = Bvapg);
      //================================================================================================================
      
        //Output Variables-Connectors
        Real Tout(min = 0, start = Tg) "Temperature for which calculations are made";
        Real Pout(min = 0, start = Pguess) "outlet pressure in Pa";
        //Total molar flow rates of respective phases in the outlet streams
        Real Ftoto[3](each min = 0,start =Fguess) "Total Outlet Molar Flow Rate";
        Real Fcompo[3, Noc](each min = 0, start={Fguess,Fguess,Fguess}) "Component outlet molar flow rate";
        Real xout[3, Noc](each min = 0, start={xguess,xguess,xguess}) "Mole Fraction of components in outlet stream";
        Real Hout, Sout, outVapfrac(min = 0, max = 1, start = Bvapg);
      //================================================================================================================
        //Phase-Equilibria
        Real Pdew(unit = "Pa", start = Pguess, min = 0);
        Real Pbubl(min = 0, unit = "Pa", start = Pguess);
        Real Bpfr(start = Bvapg);
        //Phase-Equilibria-Outlet Stream
        Real Pdewo(unit = "Pa", start = Pguess, min = 0);
        Real Pbublo(min = 0, unit = "Pa", start = Pguess);
        Real Bout(start = Bvapg);
      //=========================================================================================================
        ...
        Real Mtot[3](start = Fguess) "Mass Flow Rate of phases";
        ...
        Real Fo[Noc](each min = 0, start = Fguess);
        Real F[Noc](each min = 0, start = Fguess);
        ...
        Real X[Noc](each min = 0, each max = 1, start=xguess) "Conversion of the reaction components";
        Real Volume "Volume of the reactor";
      ...
      //==================================================================================================================
        ...
        Real Qflow "The total energy given out/taken in due to the reactions";
        Simulator.Files.Connection.matConn inlet(Cnoc = Noc) annotation(
      ...
      //Connector-Equations
        ...
        outlet.Hmol = Hout;
        outlet.Smol = Sout;
        outlet.xfrac[1, :] = xout[1, :];
        outlet.Bfrac = outVapfrac;
        en_Conn.Qflow = Qflow;
      //Phase Equilibria
      //==========================================================================================================
      //Bubble point calculation
        Pbubl = sum(gammaBubl[:] .* xin[1, :] .* exp(comp[:].VP[2] + comp[:].VP[3] / T + comp[:].VP[4] * log(T) + comp[:].VP[5] .* T .^ comp[:].VP[6]) ./ liqfugcoeff_bubl[:]);
      //Dew point calculation
        Pdew = 1 / sum(xin[1, :] ./ (gammaDew[:] .* exp(comp[:].VP[2] + comp[:].VP[3] / T + comp[:].VP[4] * log(T) + comp[:].VP[5] .* T .^ comp[:].VP[6])) .* vapfugcoeff_dew[:]);
        if P >= Pbubl then
      //below bubble point region
          xin[3, :] = zeros(Noc);
          sum(xin[2, :]) = 1;
      ...
      //Rachford Rice Equation
        for i in 1:Noc loop
          xin[1, i] = xin[3, i] * Bpfr + xin[2, i] * (1 - Bpfr);
        end for;
      //===========================================================================================================
      //Calculation of Mass Fraction
      //Average Molecular Weights of respective phases
        if Bpfr <= 0 then
          Mavg[1] = sum(xin[1, :] .* comp[:].MW);
          Mavg[2] = sum(xin[2, :] .* comp[:].MW);
          Mavg[3] = 0;
         Mtot[1] = Ftot[1] * 1E-3 * Mavg[1];
         Mtot[2] = Ftot[2] * 1E-3 * Mavg[2];
         Mtot[3] = 0;
          compMasFrac[1, :] = xin[1, :] .* comp[:].MW / Mavg[1];
          compMasFrac[2, :] = xin[2, :] .* comp[:].MW / Mavg[2];
          for i in 1:Noc loop
            compMasFrac[3, i] = 0;
          end for;
      //Rholiq
          Rhol = Thermodynamic_Functions.Density_Racket(Noc, T, P, comp[:].Pc, comp[:].Tc, comp[:].Racketparam, comp[:].AF, comp[:].MW, Psat[:]);
          Rholiq = 1 / sum(compMasFrac[2, :] ./ Rhol[:]) / Mavg[2];
      ...
      //Density of Inlet-Mixture
          Density_Mixture = 1 / ((1 - Bpfr) / Rholiq) * sum(xin[1, :] .* comp[:].MW);
      //====================================================================================================
        elseif Bpfr == 1 then
          Mavg[1] = sum(xin[1, :] .* comp[:].MW);
          Mavg[2] = 0;
          Mavg[3] = sum(xin[3, :] .* comp[:].MW);
         Mtot[1] = Ftot[1] * 1E-3 * Mavg[1];
         Mtot[2] = 0;
         Mtot[3] = Ftot[3] * 1E-3 * Mavg[3];
          compMasFrac[1, :] = xin[1, :] .* comp[:].MW / Mavg[1];
          for i in 1:Noc loop
            compMasFrac[2, i] = 0;
          end for;
          compMasFrac[3, :] = xin[3, :] .* comp[:].MW / Mavg[3];
      ...
      //Vapour Phase Density
          for i in 1:Noc loop
            Rhov[i] = P / (Zv * 8.314 * T) * comp[i].MW * 1E-3;
          end for;
          Rhovap = 1 / sum(compMasFrac[3, :] ./ Rhov[:]) / Mavg[3];
      //Density of Inlet-Mixture
          Density_Mixture = 1 / (Bpfr / Rhovap) * sum(xin[1, :] .* comp[:].MW);
        else
          Mavg[1] = sum(xin[1, :] .* comp[:].MW);
          Mavg[2] = sum(xin[2, :] .* comp[:].MW);
          Mavg[3] = sum(xin[3, :] .* comp[:].MW);
      ...
      //Vapour Phase Density
          ...
          Rhovap = 1 / sum(compMasFrac[3, :] ./ Rhov[:]) / Mavg[3];
      //Density of Inlet-Mixture
          Density_Mixture = 1 / (Bpfr / Rhovap + (1 - Bpfr) / Rholiq) * sum(xin[1, :] .* comp[:].MW);
        end if;
      //=====================================================================================================
      //Phase Flow Rates
      //Phase Molar Flow Rates
        Ftot[3] = Ftot[1] * Bpfr;
        Ftot[2] = Ftot[1] * (1 - Bpfr);
      //Component Molar Flow Rates in Phases
        Fcomp[1, :] = Ftot[1] .* xin[1, :];
        Fcomp[2, :] = Ftot[2] .* xin[2, :];
        Fcomp[3, :] = Ftot[3] .* xin[3, :];
      //======================================================================================================
      //Phase Volumetric flow rates
        if Phase == 1 then
          Qvol[1] =Mtot[1] / Density_Mixture;
          Qvol[2] =Mtot[2] / (Rholiq * Mavg[2]);
          Qvol[3] =Mtot[3] / (Rhovap * Mavg[3]);
        elseif Phase == 2 then
          Qvol[1] =Mtot[1] / Density_Mixture;
          Qvol[2] =Mtot[2] / (Rholiq * Mavg[2]);
          Qvol[3] = 0;
        ...
        if Phase == 1 then
          ...
          for i in 1:Noc loop
            if i == Base_comp then
              ...
              Fo[i] = Fcomp[1, i];
              F[i] = No[i, 1] * Fo[i] + Sc[i, 1] / Bc[1] * X[Base_comp] * Fcomp[1, Base_comp];
            end if;
          end for;
      //Conversion of Reactants
          for j in 2:Noc loop
            if Sc[j, 1] < 0 then
              X[j] = (Fcomp[Phase, j] - F[j]) / Fcomp[Phase, j];
            else
              X[j] = 0;
            end if;
          end for;
      ...
      //Conversion of Reactants
          for j in 2:Noc loop
            if Sc[j, 1] < 0 then
              X[j] = (Fcomp[Phase, j] - Fcompo[Phase, j]) / Fcomp[Phase, j];
            else
              X[j] = 0;
            end if;
          end for;
      ...
      //Isothermal Mode
        if Mode == 1 then
          ...
          Tout = T;
          Qflow = Reaction_Heat - Hin / Mavg[1] *Mtot[1] + Hout / Mavg[1] *Mtot[1];
      ...
      //Adiabatic Mode
          ...
          Reaction_Heat = HOR[1] * 1E-3 * Fo[Base_comp] * X[Base_comp];
          Qflow = 0;
          Hout / Mavgo[1] = Hin / Mavg[1] - Reaction_Heat;
        end if;
      //===========================================================================================================
      ...
      //Bubble point calculation
        Pbublo = sum(gammaBubl[:] .* xout[1, :] .* exp(comp[:].VP[2] + comp[:].VP[3] / Tout + comp[:].VP[4] * log(Tout) + comp[:].VP[5] .* Tout .^ comp[:].VP[6]) ./ liqfugcoeff_bubl[:]);
      //Dew point calculation
        Pdewo = 1 / sum(xout[1, :] ./ (gammaDew[:] .* exp(comp[:].VP[2] + comp[:].VP[3] / Tout + comp[:].VP[4] * log(Tout) + comp[:].VP[5] .* Tout .^ comp[:].VP[6])) .* vapfugcoeff_dew[:]);
        if Pout >= Pbublo then
      //below bubble point region
          xout[3, :] = zeros(Noc);
          sum(xout[2, :]) = 1;
        elseif Pout <= Pdewo then
      //above dew point region
          xout[2, :] = zeros(Noc);
          sum(xout[3, :]) = 1;
        else
      ...
      //Rachford Rice Equation
        for i in 1:Noc loop
          xout[1, i] = xout[3, i] * Bout + xout[2, i] * (1 - Bout);
        end for;
        Ftoto[3] = Ftoto[1] * Bout;
        Ftoto[2] = Ftoto[1] * (1 - Bout);
      //===========================================================================================================
      //Calculation of Mass Fraction
      //Average Molecular Weights of respective phases
        if Bout <= 0 then
          Mavgo[1] = sum(xout[1, :] .* comp[:].MW);
          Mavgo[2] = sum(xout[2, :] .* comp[:].MW);
          Mavgo[3] = 0;
      //====================================================================================================
        elseif Bout == 1 then
          Mavgo[1] = sum(xout[1, :] .* comp[:].MW);
          Mavgo[2] = 0;
          Mavgo[3] = sum(xout[3, :] .* comp[:].MW);
        else
          Mavgo[1] = sum(xout[1, :] .* comp[:].MW);
          Mavgo[2] = sum(xout[2, :] .* comp[:].MW);
          Mavgo[3] = sum(xout[3, :] .* comp[:].MW);
      ...
      //=====================================================================================================
      //Component Molar Flow Rates in Phases
        Fcompo[1, :] = Ftoto[1] .* xout[1, :];
        Fcompo[2, :] = Ftoto[2] .* xout[2, :];
        Fcompo[3, :] = Ftoto[3] .* xout[3, :];
      //==================================================================================================
        annotation(
    ...
    package Distillation_Column
      model Cond
        ...
        parameter Chemsep_Database.General_Properties comp[Noc];
        Real P(start = Pguess), T(start = Tg);
        Real Fcond(start = Fguess);
        Real Fsdraw(start = Fguess);
        Real Fvap(start = Fguess);
        Real Fliq(start = Fguess);
        Real xfeed[Noc](start = xguess);
        Real xsdraw[Noc](start = xguess);
        Real xvapin[Noc](each min = 0, each max = 1, start = xguess);
        Real xliqo[Noc](each min = 0, each max = 1, start = xguess);
        Real Hfeed(start = Htotg);
        Real Hvapin(start = Htotg);
        Real Hliqo(start = Htotg);
        Real Qheat, Hsdraw(start = Htotg);
        Real Hcompl[Noc](start = Htotg);
        Real xcomp[3, Noc](each min = 0, each max = 1, start = {xguess,xguess,xguess});
        Real Pdew(start = Pmax), Pbubl(start = Pmin);
        //String sideDrawType(start = "Null");
        //L or V
        parameter String Ctype "Partial or Total";
        replaceable Simulator.Files.Connection.matConn feed(Cnoc = Noc) if boolFeed annotation(
          Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Simulator.Files.Connection.matConn dummy_feed(Cnoc = Noc, P = 0, T = 0, xfrac = zeros(3, Noc), Fmol = 0, Hmol = 0, Smol = 0, Bfrac = 0) if not boolFeed annotation(
          Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Simulator.Files.Connection.matConn side_draw(Cnoc = Noc) annotation(
          Placement(visible = true, transformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Simulator.Files.Connection.trayConn liquid_outlet(Cnoc = Noc) annotation(
        ...
        Simulator.Files.Connection.trayConn vapor_inlet(Cnoc = Noc) annotation(
          Placement(visible = true, transformation(origin = {50, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {50, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
//connector equation
        if boolFeed then
          ...
          dummy_feed.xfrac[1, :] = xfeed[:];
          dummy_feed.Hmol = Hfeed;
          dummy_feed.Fmol = Fcond;
        end if;
        side_draw.P = P;
        side_draw.T = T;
        side_draw.xfrac[1, :] = xsdraw[:];
        side_draw.Fmol = Fsdraw;
        side_draw.Hmol = Hsdraw;
        liquid_outlet.Fmol = Fliq;
        liquid_outlet.Hmol = Hliqo;
        liquid_outlet.xfrac[:] = xliqo[:];
        vapor_inlet.Fmol = Fvap;
        vapor_inlet.Hmol= Hvapin;
        vapor_inlet.xfrac[:] = xvapin[:];
        heat_load.Qflow = Qheat;
//Adjustment for thermodynamic packages
        xcomp[1, :] = (Fsdraw .* xsdraw[:] + Fliq .* xliqo[:]) ./ (Fsdraw + Fliq);
        xcomp[2, :] = xliqo[:];
        xcomp[3, :] = K[:] .* xcomp[2, :];
//Bubble point calculation
        Pbubl = sum(gammaBubl[:] .* xcomp[1, :] .* Psat[:] ./ liqfugcoeff_bubl[:]);
//Dew point calculation
        Pdew = 1 / sum(xcomp[1, :] ./ (gammaDew[:] .* Psat[:]) .* vapfugcoeff_dew[:]);
//molar balance
//Fcond + Fvap = Fsdraw + Fliq;
        Fcond .* xfeed[:] + Fvap .* xvapin[:] = Fsdraw .* xsdraw[:] + Fliq .* xliqo[:];
//equillibrium
...
//  sum(xliqo[:]) = 1;
        sum(xsdraw[:]) = 1;
// Enthalpy balance
        Fcond * Hfeed + Fvap * Hvapin = Fsdraw * Hsdraw + Fliq * Hliqo + Qheat;
//Temperature calculation
        if Ctype == "Total" then
          P = sum(xsdraw[:] .* Psat[:]);
...
// outlet liquid molar enthalpy calculation
        for i in 1:Noc loop
          Hcompl[i] = Simulator.Files.Thermodynamic_Functions.HLiqId(comp[i].SH, comp[i].VapCp, comp[i].HOV, comp[i].Tc, T);
        end for;
        Hliqo = sum(xliqo[:] .* Hcompl[:]) + Hres[2];
        annotation(
      ...
      model DistTray
        ...
        parameter Chemsep_Database.General_Properties comp[Noc];
        Real P(start = Pguess), T(start = Tg);
        Real Ftray(start = Fguess);
        Real Fsdraw(start = Fguess);
        Real Fvap[2](start = {Fguess, Fvapg});
        Real Fliq[2](start = {Fguess, Fliqg});
        Real xfeed[Noc](start = xguess);
        Real xsdraw[Noc](start = xguess);
        Real xvap[2, Noc](start = {xguess, xguess});
        Real xliq[2, Noc](start = {xguess, xguess});
        Real Hfeed(start = Htotg);
        Real Hvap[2](start = {Htotg, Hvapg});
        Real Hliq[2](start = {Htotg, Hliqg}), Qtray;
        Real Hsdraw;
        Real Hcompv[Noc](start = Hvapg);
        Real Hcompl[Noc](start = Hliqg);
        Real xcomp[3, Noc](start = {xguess, xguess, xguess});
        Real Pdew(start = Pmax), Pbubl(start = Pmin);
        Real Dp1, Dt1, Dxfrac[3, Noc], Dxflow, Dxenth, Dxentr, Dbfrac;
        //this is adjustment done since OpenModelica 1.11 is not handling array modification properly
        String Sdtype(start = "Null");
        //L or V
        replaceable Simulator.Files.Connection.matConn feed(Cnoc = Noc) if boolFeed annotation(
          Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        replaceable Simulator.Files.Connection.matConn dummy_feed(Cnoc = Noc, P = 0, T = 0, Fmol = 0, xfrac = zeros(3, Noc), Hmol = 0, Smol = 0, Bfrac = 0) if not boolFeed annotation(
          Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Simulator.Files.Connection.matConn side_draw(Cnoc = Noc) annotation(
          Placement(visible = true, transformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Simulator.Files.Connection.trayConn liquid_inlet(Cnoc = Noc) annotation(
          Placement(visible = true, transformation(origin = {-50, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-50, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Simulator.Files.Connection.trayConn liquid_outlet(Cnoc = Noc) annotation(
          Placement(visible = true, transformation(origin = {-50, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-50, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Simulator.Files.Connection.trayConn vapor_outlet(Cnoc = Noc) annotation(
          Placement(visible = true, transformation(origin = {50, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {50, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Simulator.Files.Connection.trayConn vapor_inlet(Cnoc = Noc) annotation(
          Placement(visible = true, transformation(origin = {50, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {50, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Simulator.Files.Connection.enConn heat_load annotation(
...
//this is adjustment done since OpenModelica 1.11 is not handling array modification properly
          ...
          dummy_feed.P = Dp1;
          dummy_feed.T = Dt1;
          dummy_feed.xfrac = Dxfrac;
          dummy_feed.Fmol = Dxflow;
          dummy_feed.Hmol = Dxenth;
          dummy_feed.Smol = Dxentr;
          dummy_feed.Bfrac = Dbfrac;
        end if;
//this is adjustment done since OpenModelica 1.11 is not handling array modification properly
        Dxfrac[1, :] = xfeed[:];
        Dxenth = Hfeed;
        ...
        side_draw.Fmol = Fsdraw;
        side_draw.Hmol = Hsdraw;
        liquid_inlet.Fmol = Fliq[1];
        liquid_inlet.Hmol = Hliq[1];
        liquid_inlet.xfrac[:] = xliq[1, :];
        liquid_outlet.Fmol = Fliq[2];
        liquid_outlet.Hmol = Hliq[2];
        liquid_outlet.xfrac[:] = xliq[2, :];
        vapor_inlet.Fmol = Fvap[1];
        vapor_inlet.Hmol = Hvap[1];
        vapor_inlet.xfrac[:] = xvap[1, :];
        vapor_outlet.Fmol = Fvap[2];
        vapor_outlet.Hmol = Hvap[2];
        vapor_outlet.xfrac[:] = xvap[2, :];
        heat_load.Qflow = Qtray;
//Adjustment for thermodynamic packages
        xcomp[1, :] = (Fsdraw .* xsdraw[:] + Fvap[2] .* xvap[2, :] + Fliq[2] .* xliq[2, :]) / (Fliq[2] + Fvap[2] + Fsdraw);
        xcomp[2, :] = xliq[2, :];
        xcomp[3, :] = xvap[2, :];
//Bubble point calculation
        Pbubl = sum(gammaBubl[:] .* xcomp[1, :] .* Psat[:] ./ liqfugcoeff_bubl[:]);
//Dew point calculation
        Pdew = 1 / sum(xcomp[1, :] ./ (gammaDew[:] .* Psat[:]) .* vapfugcoeff_dew[:]);
//molar balance
//Ftray + Fvap[1] + Fliq[1] = Fsdraw + Fvap[2] + Fliq[2];
        Ftray .* xfeed[:] + Fvap[1] .* xvap[1, :] + Fliq[1] .* xliq[1, :] = Fsdraw .* xsdraw[:] + Fvap[2] .* xvap[2, :] + Fliq[2] .* xliq[2, :];
//equillibrium
        xvap[2, :] = K[:] .* xliq[2, :];
//raschford rice
//    xliq[2,:] = ((Ftray .* xfeed[:] + Fvap[1] .* xvap[1, :] + Fliq[1] .* xliq[1, :])./(Ftray + Fvap[1] + Fliq[1])) ./(1 .+ (Fvap[2]/ (Fvap[2] + Fliq[2])) * (K[:] .- 1));
//  for i in 1:Noc loop
//    xvap[2,i] = ((K[i]/(K[1])) * xliq[2,i]) / (1 + (K[i] / (K[1])) * xliq[2,i]);
//  end for;
//summation equation
        sum(xliq[2, :]) = 1;
        sum(xvap[2, :]) = 1;
// Enthalpy balance
        Ftray * Hfeed + Fvap[1] * Hvap[1] + Fliq[1] * Hliq[1] = Fsdraw * Hsdraw + Fvap[2] * Hvap[2] + Fliq[2] * Hliq[2] + Qtray;
//enthalpy calculation
        for i in 1:Noc loop
          Hcompl[i] = Thermodynamic_Functions.HLiqId(comp[i].SH, comp[i].VapCp, comp[i].HOV, comp[i].Tc, T);
          Hcompv[i] = Thermodynamic_Functions.HVapId(comp[i].SH, comp[i].VapCp, comp[i].HOV, comp[i].Tc, T);
        end for;
        Hliq[2] = sum(xliq[2, :] .* Hcompl[:]) + Hres[2];
        Hvap[2] = sum(xvap[2, :] .* Hcompv[:]) + Hres[3];
//sidedraw calculation
        if Sdtype == "L" then
          xsdraw[:] = xliq[2, :];
        elseif Sdtype == "V" then
          xsdraw[:] = xvap[2, :];
        else
          xsdraw[:] = zeros(Noc);
        end if;
      ...
      model Reb
        ...
        Real P(start = Pguess);
        Real T(start = Tg);
        Real Freb(start = Fguess);
        Real Fsdraw(start = Fguess);
        Real Fvap(start = Fvapg);
        Real Fliq(start = Fliqg);
        Real xfeed[Noc](start = xguess);
        Real xsdraw[Noc](start = xguess);
        Real xvap[Noc](start = xguess);
        Real xliq[Noc](start = xguess);
        Real Hfeed(start = Htotg);
        Real Hvap(start = Hvapg);
        Real Hliq(start = Hliqg);
        Real Hcompv[Noc](start =Hcompg);
        Real Qheat;
        Real Hsdraw;
        Real xcomp[3, Noc](each min = 0, each max = 1, start = {xguess,xguess,xguess});
        Real Pdew(start = Pmax), Pbubl(start = Pmin);
        replaceable Simulator.Files.Connection.matConn feed(Cnoc = Noc) if boolFeed annotation(
          Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        replaceable Simulator.Files.Connection.matConn dummy_feed(Cnoc = Noc, P = 0, T = 0, xfrac = zeros(3, Noc), Fmol = 0, Hmol = 0, Smol = 0, Bfrac = 0) if not boolFeed annotation(
          Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Simulator.Files.Connection.matConn side_draw(Cnoc = Noc) annotation(
          Placement(visible = true, transformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Simulator.Files.Connection.trayConn liquid_inlet(Cnoc = Noc) annotation(
...
//connector equation
        ...
        side_draw.Fmol = Fsdraw;
        side_draw.Hmol = Hsdraw;
        liquid_inlet.Fmol = Fliq;
        liquid_inlet.Hmol = Hliq;
        liquid_inlet.xfrac[:] = xliq[:];
        vapor_outlet.Fmol = Fvap;
        vapor_outlet.Hmol = Hvap;
        vapor_outlet.xfrac[:] = xvap[:];
        heat_load.Qflow = Qheat;
//Adjustment for thermodynamic packages
        xcomp[1, :] = (Fsdraw .* xsdraw[:] + Fvap .* xvap[:]) ./ (Fsdraw + Fvap);
        xcomp[2, :] = xsdraw[:];
//This equation is temporarily valid since this is only "partial" reboiler. Rewrite equation when "total" reboiler functionality is added
        xcomp[3, :] = xvap[:];
//Bubble point calculation
        Pbubl = sum(gammaBubl[:] .* xcomp[1, :] .* exp(comp[:].VP[2] + comp[:].VP[3] / T + comp[:].VP[4] * log(T) + comp[:].VP[5] .* T .^ comp[:].VP[6]) ./ liqfugcoeff_bubl[:]);
//Dew point calculation
        Pdew = 1 / sum(xcomp[1, :] ./ (gammaDew[:] .* exp(comp[:].VP[2] + comp[:].VP[3] / T + comp[:].VP[4] * log(T) + comp[:].VP[5] .* T .^ comp[:].VP[6])) .* vapfugcoeff_dew[:]);
//molar balance
//  Freb + Fliq = Fsdraw + Fvap;
        for i in 1:Noc loop
          Freb .* xfeed[i] + Fliq .* xliq[i] = Fsdraw .* xsdraw[i] + Fvap .* xvap[i];
        end for;
//equillibrium
        xvap[:] = K[:] .* xsdraw[:];
//summation equation
//    sum(xvap[:]) = 1;
        sum(xsdraw[:]) = 1;
        for i in 1:Noc loop
          Hcompv[i] = Simulator.Files.Thermodynamic_Functions.HVapId(comp[i].SH, comp[i].VapCp, comp[i].HOV, comp[i].Tc, T);
        end for;
        Hvap = sum(xvap[:] .* Hcompv[:]) + Hres[3];
// bubble point calculations
        P = sum(xsdraw[:] .* exp(comp[:].VP[2] + comp[:].VP[3] / T + comp[:].VP[4] * log(T) + comp[:].VP[5] .* T .^ comp[:].VP[6]));
//    Fsdraw = 10;
        Freb * Hfeed + Fliq * Hliq = Fsdraw * Hsdraw + Fvap * Hvap + Qheat;
        annotation(
          Diagram(coordinateSystem(extent = {{-100, -40}, {100, 40}})),
          Icon(coordinateSystem(extent = {{-100, -40}, {100, 40}})),
          __OpenModelica_commandLineOptions = "");
      ...
      model DistCol
        ...
        Simulator.Files.Connection.matConn feed[noOfFeeds](each Cnoc = Noc) annotation(
        ...
        Simulator.Files.Connection.matConn side_draw[noOfSideDraws](each Cnoc = Noc) annotation(
        ...
        Simulator.Files.Connection.enConn heat_load[noOfHeatLoads](each Cnoc = Noc) annotation(
...
//this is adjustment done since OpenModelica 1.11 is not handling array modification properly
            feed[i].P = tray[feedStages[i] - 1].Dp1;
            feed[i].T = tray[feedStages[i] - 1].Dt1;
            feed[i].Fmol = tray[feedStages[i] - 1].Dxflow;
            feed[i].xfrac = tray[feedStages[i] - 1].Dxfrac;
            feed[i].Hmol = tray[feedStages[i] - 1].Dxenth;
            feed[i].Smol = tray[feedStages[i] - 1].Dxentr;
            feed[i].Bfrac = tray[feedStages[i] - 1].Dbfrac;
          end if;
        end for;
...
//tray pressures
        ...
        for i in 2:noOfStages - 1 loop
          tray[i - 1].Sdtype = "Null";
          tray[i - 1].side_draw.xfrac = zeros(3, Noc);
          tray[i - 1].side_draw.Fmol = 0;
          tray[i - 1].side_draw.Hmol = 0;
          tray[i - 1].side_draw.Smol = 0;
          tray[i - 1].side_draw.Bfrac = 0;
          tray[i - 1].Qtray = 0;
        end for;
        refluxRatio = condensor.Fliq / condensor.side_draw.Fmol;
        annotation(
          Icon(coordinateSystem(extent = {{-250, -600}, {250, 600}})),
          Diagram(coordinateSystem(extent = {{-250, -600}, {250, 600}})),
          __OpenModelica_commandLineOptions = "");
    ...
    package Absorption_Column
      model AbsTray
        ...
        Real P(start = Pguess);
        Real T(start = Tg);
        Real Fvap[2](start = {Fguess, Fguess});
        Real Fliq[2](start = {Fguess, Fguess});
        Real xvap[2, Noc](start = {xguess, xguess});
        Real xliq[2, Noc](each min = 0, each max = 1, start = {xguess, xguess});
        Real Hvap[2](start = {Hliqg, Hvapg});
        Real Hliq[2](start = {Hliqg, Hvapg});
        Real Hvcomp[Noc](start = Hvapg);
        Real Hlcomp[Noc](start = Hliqg);
        Real xabs[3, Noc](each min = 0, each max = 0, start = {xguess, xguess, xguess});
        Real Pdew(start = Pmax), Pbubl(start = Pmin);
        Simulator.Files.Connection.trayConn liquid_inlet(Cnoc = Noc) annotation(
          Placement(visible = true, transformation(origin = {-50, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-50, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Simulator.Files.Connection.trayConn liquid_outlet(Cnoc = Noc) annotation(
...
//connector equation
        ...
        vapor_outlet.xfrac[:] = xvap[2, :];
//Adjustment for thermodynamic packages
        xabs[1, :] = (Fvap[2] .* xvap[2, :] + Fliq[2] .* xliq[2, :]) / (Fliq[2] + Fvap[2]);
        xabs[2, :] = xliq[2, :];
        xabs[3, :] = xvap[2, :];
//Bubble point calculation
        Pbubl = sum(gammaBubl[:] .* xabs[1, :] .* exp(comp[:].VP[2] + comp[:].VP[3] / T + comp[:].VP[4] * log(T) + comp[:].VP[5] .* T .^ comp[:].VP[6]) ./ liqfugcoeff_bubl[:]);
//Dew point calculation
        Pdew = 1 / sum(xabs[1, :] ./ (gammaDew[:] .* exp(comp[:].VP[2] + comp[:].VP[3] / T + comp[:].VP[4] * log(T) + comp[:].VP[5] .* T .^ comp[:].VP[6])) .* vapfugcoeff_dew[:]);
//molar balance
        Fvap[1] .* xvap[1, :] + Fliq[1] .* xliq[1, :] = Fvap[2] .* xvap[2, :] + Fliq[2] .* xliq[2, :];
//equillibrium
        xvap[2, :] = K[:] .* xliq[2, :];
//raschford rice
//  xliq[2, :] = ((Fvap[1] .* xvap[1, :] + Fliq[1] .* xliq[1, :])/(Fvap[1] + Fliq[1]))./(1 .+ (Fvap[1]/(Fliq[1] + Fvap[1])) .* (K[:] .- 1));
//  for i in 1:Noc loop
//    xvap[2,i] = ((K[i]/(K[1])) * xliq[2,i]) / (1 + (K[i] / (K[1])) * xliq[2,i]);
//  end for;
//summation equation
        ...
        sum(xvap[2, :]) = 1;
// Enthalpy balance
        Fvap[1] * Hvap[1] + Fliq[1] * Hliq[1] = Fvap[2] * Hvap[2] + Fliq[2] * Hliq[2];
//enthalpy calculation
        for i in 1:Noc loop
          Hlcomp[i] = Thermodynamic_Functions.HLiqId(comp[i].SH, comp[i].VapCp, comp[i].HOV, comp[i].Tc, T);
          Hvcomp[i] = Thermodynamic_Functions.HVapId(comp[i].SH, comp[i].VapCp, comp[i].HOV, comp[i].Tc, T);
        end for;
        Hliq[2] = sum(xliq[2, :] .* Hlcomp[:]) + Hres[2];
        Hvap[2] = sum(xvap[2, :] .* Hvcomp[:]) + Hres[3];
        annotation(
          Diagram(coordinateSystem(extent = {{-100, -40}, {100, 40}})),
          Icon(coordinateSystem(extent = {{-100, -40}, {100, 40}})),
          __OpenModelica_commandLineOptions = "");
      ...
      model AbsCol
        ...
        parameter data.General_Properties comp[Noc];
        Simulator.Files.Connection.matConn top_feed(Cnoc = Noc) annotation(
        ...
        Simulator.Files.Connection.matConn bottom_feed(Cnoc = Noc) annotation(
        ...
        Simulator.Files.Connection.matConn top_product(Cnoc = Noc) annotation(
          Placement(visible = true, transformation(origin = {100, 80}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {250, 300}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Simulator.Files.Connection.matConn bottom_product(Cnoc = Noc) annotation(
          Placement(visible = true, transformation(origin = {100, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {250, -300}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      equation
//connector equation
        tray[1].Fliq[1] = top_feed.Fmol;
        tray[1].xliq[1, :] = top_feed.xfrac[1, :];
        tray[1].Hliq[1] = top_feed.Hmol;
        tray[1].Fvap[2] = top_product.Fmol;
        tray[1].xvap[2, :] = top_product.xfrac[1, :];
//  tray[1].Hvap[2] = top_product.Hmol;
        tray[1].T = top_product.T;
        tray[noOfStages].Fliq[2] = bottom_product.Fmol;
        tray[noOfStages].xliq[2, :] = bottom_product.xfrac[1, :];
//  tray[noOfStages].Hliq[2] = bottom_product.Hmol;
        tray[noOfStages].T = bottom_product.T;
        tray[noOfStages].Fvap[1] = bottom_feed.Fmol;
        tray[noOfStages].xvap[1, :] = bottom_feed.xfrac[1, :];
        tray[noOfStages].Hvap[1] = bottom_feed.Hmol;
...
//tray pressures
    ...
    model Recycle_Block
      ...
      //========================================================================================
      Real xin[Noc](each min = 0, each max = 1, start = xguess) "mixture mole fraction";
      Real xout[Noc](each min = 0, each max = 1, start = xguess);
      parameter Integer Noc "number of components";
      parameter Simulator.Files.Chemsep_Database.General_Properties comp[Noc];
      //========================================================================================
      Simulator.Files.Connection.matConn inlet(Cnoc = Noc) annotation(
...
//Here vapor phase mole fraction, temperature, mixture component mole fraction and mixture molar flow is given.
    ...
    model msPH
      ...
      //we need to give proper initialization values for converging, Initialization values are provided for Ftot, xmol and T while extending.
      //Noc - number of components, comp -  component array.
      extends Simulator.Files.Thermodynamic_Packages.Raoults_Law;
      //Thermodynamic package is extended. We can use other thermodynamics also(not yet added) after little modification and inclusion of residual properties equations.
    equation
...
//1 stands for mixture
    ...
    model msTPNRTL
      ...
      parameter data.Ethanol eth;
      extends Simulator.Streams.Material_Stream(Noc = 2, comp = {ohex, eth});
    ...
    package heater1
      ...
      model heat
        ...
        Simulator.Unit_Operations.Heater heater1(Deltap = 101325, Eff = 1, Noc = Noc, comp = comp) annotation(
...
//heat added
    ...
    package Heat_Exchanger_test
      ...
      model HX_Test
        ...
        Simulator.Unit_Operations.Heat_Exchanger HX(Calculation_Method = "Outlet_Temparatures", Heat_Loss = 0, Mode = "CoCurrent", Noc = Noc, comp = comp, deltap_cold = 0, deltap_hot = 0) annotation(
      ...
      equation
        ...
        Hot_In.xmol[1, :] = {1, 0};
        Cold_In.xmol[1, :] = {0, 1};
        Hot_In.Ftot[1] = 181.46776;
        Cold_In.Ftot[1] = 170.93083;
        Hot_In.T = 422.03889;
        Cold_In.T = 310.92778;
    ...
    package cooler1
      ...
      model cool
        ...
        parameter data.Water wat;
        //instantiation of water
        Simulator.Unit_Operations.Cooler cooler1(Deltap = 0, Eff = 1, Noc = 3, comp = {meth, eth, wat}) annotation(
          Placement(visible = true, transformation(origin = {-8, 18}, extent = {{-14, -14}, {14, 14}}, rotation = 0)));
        Simulator.Test.cooler1.ms inlet(Noc = 3, comp = {meth, eth, wat}) annotation(
...
//input molar flow
    ...
    package mix1
      ...
      model mix
        ...
        Simulator.Unit_Operations.Mixer mixer1(Noc = Noc, NI = 6, comp = comp, Pexit= "Inlet_Average") annotation(
      ...
      equation
        ...
        ms5.Ftot[1] = 400;
        ms6.Ftot[1] = 200;
        ms1.xmol[1, :] = {0.25, 0.25, 0.5};
        ms2.xmol[1, :] = {0, 0, 1};
        ms3.xmol[1, :] = {0.3, 0.3, 0.4};
        ms4.xmol[1, :] = {0.25, 0.25, 0.5};
        ms5.xmol[1, :] = {0.2, 0.4, 0.4};
        ms6.xmol[1, :] = {0, 1, 0};
      end mix;
    end mix1;
    ...
    package comp_sep1
      ...
      model main
        ...
        Simulator.Unit_Operations.Compound_Separator compound_Separator1(Noc = 2, comp = {benz, tol}, Sfact = {"Molar_Flow", "Mass_Flow"}, Stream = 1) annotation(
      ...
      equation
        ...
        Inlet.Ftot[1] = 100;
        compound_Separator1.Sval = {20, 1500};
      end main;
    end comp_sep1;
    ...
    package shortcut1
      ...
      model main
        ...
        Simulator.Test.shortcut1.ms feed(Noc = Noc, comp = comp) annotation(
          Placement(visible = true, transformation(origin = {-79, 15}, extent = {{-13, -13}, {13, 13}}, rotation = 0)));
        Simulator.Test.shortcut1.ms bottoms(Noc = Noc, comp = comp) annotation(
          Placement(visible = true, transformation(origin = {64, -18}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Simulator.Test.shortcut1.ms distillate(Noc = Noc, comp = comp) annotation(
      ...
      equation
        ...
        feed.xmol[1, :] = {0.5, 0.5};
        feed.Ftot[1] = 100;
        shortcut1.Preb = 101325;
        shortcut1.Pcnd = 101325;
        shortcut1.xmol[2, shortcut1.LKey] = 0.01;
        shortcut1.xmol[3, shortcut1.HKey] = 0.01;
        shortcut1.Ract = 2;
      end main;
    end shortcut1;
    ...
    package split
      ...
      model main
        ...
        Simulator.Unit_Operations.Splitter split(Noc = Noc, comp = comp, NO = 2, Ctype = "Molar_Flow") annotation(
...
//pressure drop
    ...
    package rigDist
      ...
      model DistColumn
        ...
        Condensor condensor(Noc = Noc, comp = comp, Ctype = Ctype, boolFeed = boolFeed[1]);
      ...
      model Test4
        ...
        parameter data.Toluene tol;
        parameter Simulator.Files.Chemsep_Database.General_Properties comp[Noc] = {benz, tol};
        DistColumn distCol(Noc = Noc, comp = comp, noOfStages = 22, noOfFeeds = 1, feedStages = {10}, condensor.Ctype = "Partial") annotation(
          Placement(visible = true, transformation(origin = {-3, 3}, extent = {{-25, -25}, {25, 25}}, rotation = 0)));
        ms feed(Noc = Noc, comp = comp) annotation(
          Placement(visible = true, transformation(origin = {-76, 2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        ms distillate(Noc = Noc, comp = comp) annotation(
...
//Conversion of Base_component
    ...
    package CR_test
      ...
      model test
        ...
        conv_react cr(Noc = Noc, comp = comp, Nr = 1, Bc = {3}, Sc = {{1}, {1}, {-1}, {-1}}, X = {0.3}, Cmode = "Define_Outlet_Temperature", Tdef = 300) annotation(
    ...
    package rigAbs
      ...
      model AbsColumn
        ...
        Tray tray[noOfStages](each Noc = Noc, each comp = comp);
      end AbsColumn;
      ...
      equation
        ...
        air_acetone.T = 335;
        air_acetone.Ftot[1] = 30;
        air_acetone.xmol[1, :] = {0.5, 0.5, 0};
      end Test;
    end rigAbs;
  end Test;
...
//Generation of Points to compute Bubble Temperature
  ...
  package Guess_Models
    model Guess_Input
      ...
      parameter Real Pguess = 101325;
      parameter Real Fguess =  125.998;
    equation
    ...
    model Initial_Guess
      ...
      //Guess variables for Pressures and Temperatures
       parameter Real xguess[Noc](each fixed = false);
       ...
       parameter Real Psatbg[Noc](each fixed = false);
       parameter Real Psatdg[Noc](each fixed = false);
     ...
     //Guess Variables for Enthalpies
       ...
       parameter Real Hcompg[Noc](each fixed = false);
       parameter Real Hcomplg[Noc](each fixed = false);
       parameter Real Hcompvg[Noc](each fixed = false);
      //Guess variables for MoleFractions
      parameter Real y[Noc](each fixed = false), x[Noc](each fixed = false);
      parameter Real xg[Noc](each fixed = false), yg[Noc](each fixed = false);
      
      //Guess for VLE variables
      parameter Real Bvapg(fixed = false), Bliqg(fixed = false);
...
//Generation of Dew Temperatures for DC_guess
      Pguess = 1 / sum(xguess[:] ./ Psatdg);
//Generation of Bubble Temperature for DC guess-(Temperatures)
      Pguess = sum(xguess[:] .* Psatbg[:]);
      for i in 1:Noc loop
        Psatbg[i] = Simulator.Files.Thermodynamic_Functions.Psat(comp[i].VP, Tbg);
        Psatdg[i] = Simulator.Files.Thermodynamic_Functions.Psat(comp[i].VP, Tdg);
      end for;
      Fguess = Fliqg + Fvapg;
      xguess[1] * Fguess = xg[1] * Fliqg + yg[1] * Fvapg;
//============================================================================
      Tc = comp.Tc;
      for i in 1:Noc loop
        Psatt[i] = Simulator.Files.Thermodynamic_Functions.Psat(comp[i].VP, Temp);
        K_guess[i] = Psatt[i] / Pguess;
      end for;
      Bliqg = 1 - Bvapg;
//=============================================================================
      if Pguess >= Pmax then
        Bvapg = 0;
      elseif Pguess >= Pmin then
        Bvapg = (Pguess - Pmin) / (Pmax - Pmin);
      else
        Bvapg = 1;
      end if;
//==============================================================================
      ...
      for i in 1:Noc loop
        if xguess[i] <> 0 then
          if Beta > 0 and Beta <> 1 then
            y[i] = xguess[i] * K_guess[i] / ((K_guess[i] - 1) * Bvapg + 1);
          elseif Beta == 1 then
            y[i] = xguess[i];
          else
            y[i] = 0;
...
//Generating the temperature in case of PH Flash
      ...
      for i in 1:Noc loop
        ...
        Hcomplg[i] = Simulator.Files.Thermodynamic_Functions.HLiqId(comp[i].SH, comp[i].VapCp, comp[i].HOV, comp[i].Tc, Temp);
        Hcompvg[i] = Simulator.Files.Thermodynamic_Functions.HVapId(comp[i].SH, comp[i].VapCp, comp[i].HOV, comp[i].Tc, Temp);
      end for;
      Htotg = Hliqg + Hvapg;
